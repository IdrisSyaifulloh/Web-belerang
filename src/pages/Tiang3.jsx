...
export default function Tiang3() {
  ...
  useEffect(() => {
    ...
    const mqttUnsubscribe = connectionService.subscribe('mqtt', ({ topic, data }) => {
      if (topic.startsWith('sensors/tiang3/')) {
  ...
  return (
    <div className="p-6 dark:bg-gray-800 min-h-screen transition-colors duration-300">
      <h2 className="text-2xl font-bold mb-4 dark:text-white">Tiang 3 - Real-time Monitoring</h2>
