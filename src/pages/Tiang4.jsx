...
export default function Tiang4() {
  ...
  useEffect(() => {
    ...
    const mqttUnsubscribe = connectionService.subscribe('mqtt', ({ topic, data }) => {
      if (topic.startsWith('sensors/tiang4/')) {
  ...
  return (
    <div className="p-6 dark:bg-gray-800 min-h-screen transition-colors duration-300">
      <h2 className="text-2xl font-bold mb-4 dark:text-white">Tiang 4 - Real-time Monitoring</h2>
